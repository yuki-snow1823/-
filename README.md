...
- バージョン管理  
チーム開発でECサイトの作成を行い、下記リポジトリでバージョン管理を行いました。
https://github.com/BlueBird1995/BlueBirdCake  
他にも、個人的にSourcetreeなどの使用経験があります。
...
自主学習会を主催したり、勉強会のイベントに参加するのがとても好きで、現在もオンラインで以下のイベントに参加しています。6月以降はフロントエンド寄りのイベントにも積極的に参加、いずれLTにも挑戦したいと考えています。  
